...
* الشعار (Logo)
* الصور
* العناصر الرسومية وذلك باستخدام أداة Canva
...
.
- آلية العمل:
لا تمتلك شركات النقل حسابات خاصة داخل التطبيق، بل يقتصر دورها على تزويدي ببيانات الرحلات فقط، بينما أتولى شخصيًا عملية إدخال البيانات وتحديثها بشكل دوري ضمن قاعدة البيانات.

- التطوير:
تم تطويره بجهد فردي كامل ابتداءً من الفكرة، مرورًا بالبرمجة، وإعداد الهوية البصرية، وصولًا إلى إدارة قاعدة البيانات دون الاستعانة بأي فريق عمل

- سبب إيقاف التطوير:
تم إيقاف العمل على تطوير التطبيق بعد إطلاق تطبيق مشابه من قِبل فريق آخر سبقني في تنفيذ الفكرة، وعليه قررت التوقف عن تطوير المشروع واعتباره تجربة تعليمية ومشروعًا شخصيًا ساهم في تطوير مهاراتي.

- الخاتمة:
شكّل هذا المشروع تجربة مهمة بالنسبة لي، وساعدني على تطوير مهاراتي في:
