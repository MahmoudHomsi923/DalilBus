...
- فكرة التطبيق:
تقوم فكرة التطبيق على توفير معلومات واضحة ومحدّثة حول الرحلات بين المحافظات السورية. التطبيق مجاني بالكامل ومتاح لجميع المستخدمين دون الحاجة إلى تسجيل أو اشتراك.
تقوم شركات النقل بإرسال جداول الرحلات الخاصة بها بصيغة ملفات Excel، وأقوم بدوري برفع هذه البيانات وتحديثها بشكل شهري ضمن قاعدة بيانات التطبيق.
