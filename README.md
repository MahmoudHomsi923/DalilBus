...
مرحبًا،
أودّ أن أقدّم لكم تطبيقي الذي يحمل اسم “DalilBuses”.

يُعد هذا التطبيق تطبيقًا مخصصًا لقطاع المواصلات داخل سوريا،
إلا أنّه يختص حصريًا بالمواصلات بين المحافظات،
ولا يشمل النقل ضمن المحافظة الواحدة.
فكرة التطبيق
تقوم فكرة التطبيق على توفير معلومات واضحة ومحدّثة حول الرحلات بين المحافظات السورية.
التطبيق مجاني بالكامل ومتاح لجميع المستخدمين دون الحاجة إلى تسجيل أو اشتراك.
تقوم شركات النقل بإرسال جداول الرحلات الخاصة بها بصيغة ملفات Excel،
وأقوم بدوري برفع هذه البيانات وتحديثها بشكل شهري ضمن قاعدة بيانات التطبيق.
ويتيح التطبيق للمستخدم:
الاطلاع على الرحلات المتوفرة بين المحافظات
معرفة خطوط السير
عرض أوقات الانطلاق
التعرّف على شركات النقل المتاحة
التقنيات والأدوات المستخدمة
تم تطوير التطبيق باستخدام الأدوات والتقنيات التالية:
لغة البرمجة C# وإطار العمل .NET MAUI
إعداد الهوية البصرية للتطبيق، بما يشمل:
الشعار (Logo)
الصور
العناصر الرسومية
وذلك باستخدام أداة Canva
استخدام قاعدة البيانات السحابية Supabase
الاعتماد على بنية سحابية حديثة لإدارة البيانات
ولا يتضمن التطبيق أي نظام دفع أو إعلانات، فهو تطبيق مجاني بالكامل.
آلية العمل
لا تمتلك شركات النقل حسابات خاصة داخل التطبيق،
بل يقتصر دورها على تزويدي ببيانات الرحلات فقط،
بينما أتولى شخصيًا عملية إدخال البيانات وتحديثها بشكل دوري ضمن قاعدة البيانات.
التطوير الفردي
أود التأكيد على أنّ هذا التطبيق:
تم تطويره بجهد فردي كامل
ابتداءً من الفكرة، مرورًا بالبرمجة، وإعداد الهوية البصرية،
وصولًا إلى إدارة قاعدة البيانات
دون الاستعانة بأي فريق عمل
سبب إيقاف التطوير
تم إيقاف العمل على تطوير التطبيق
بعد إطلاق تطبيق مشابه من قِبل فريق متكامل سبقني في تنفيذ الفكرة،
وعليه قررت التوقف عن تطوير المشروع
واعتباره تجربة تعليمية ومشروعًا شخصيًا ساهم في تطوير مهاراتي.
الخاتمة
شكّل هذا المشروع تجربة مهمة بالنسبة لي،
وساعدني على تطوير مهاراتي في:
