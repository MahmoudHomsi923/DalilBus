...
namespace DalilBus.Config
{
    public class ApiConfig
    {
        ...
        public const string TravelsEndpoint = "vwtravels?select=id,number,nameAr,nameEn,startPlaceID,startPlaceNameAr,startPlaceNameEn,destinationPlaceID,destinationPlaceNameAr,destinationPlaceNameEn,depatureDate,arrivalDate,depatureTime,arrivalTime,durationAr,durationEn,changes,stopPlaceNameAr1,stopPlaceNameEn1,stopTime1,stopDuration1,stopPlaceNameAr2,stopPlaceNameEn2,stopTime2,stopDuration2,stopPlaceNameAr3,stopPlaceNameEn3,stopTime3,stopDuration3";
